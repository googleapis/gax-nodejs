...
import type {ClientStubOptions, GrpcClient} from './grpc.js';
import type {GrpcClient as FallbackGrpcClient} from './fallback.js';
import * as protos from '../../protos/operations.js';
// @ts-ignore
import configData from './operations_client_config.json' with {type: 'json'};
import {Transform} from 'stream';
import {CancellablePromise} from './call.js';
// @ts-ignore
import operationProtoJson from '../../protos/operations.json' with {type: 'json'};
import {overrideHttpRules} from './transcoding.js';
