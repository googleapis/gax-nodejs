...
import {createApiCall as realCreateApiCall} from '../../src/createApiCall.js';
...
import {defaultToObjectOptions} from '../../src/fallback.js';

export const FAKE_STATUS_CODE_1 = 1;
...
export function createApiCallTest(func: Function, opts?: Options) {
