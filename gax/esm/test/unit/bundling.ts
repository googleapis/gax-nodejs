...
import {BundleDescriptor} from '../../src/bundlingCalls/bundleDescriptor.js';
import {
  BundleExecutor,
  BundleOptions,
} from '../../src/bundlingCalls/bundleExecutor.js';
import {computeBundleId} from '../../src/bundlingCalls/bundlingUtils.js';
import {deepCopyForResponse, Task} from '../../src/bundlingCalls/task.js';
import {GoogleError} from '../../src/googleError.js';

import {createApiCallTest} from './utils.js';
import {SimpleCallbackFunction, RequestType} from '../../src/apitypes.js';
...
describe('bundleable', () => {
  ...
  it('cancels partially on bundling method', done => {
    const apiCall = createApiCallTest(func, settings);
