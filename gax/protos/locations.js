...
const $root = $protobuf.roots.locations_protos || ($protobuf.roots.locations_protos = {});
        ...
        cloud.location = (function() {
            ...
            location.ListLocationsRequest = (function() {
                ...
                ListLocationsRequest.decode = function decode(reader, length) {
                    ...
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.location.ListLocationsRequest();
                ...
                ListLocationsRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.cloud.location.ListLocationsRequest)
                        return object;
                    let message = new $root.google.cloud.location.ListLocationsRequest();
                    if (object.name != null)
                 ...
                 */
                ListLocationsRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/google.cloud.location.ListLocationsRequest";
                };
            ...
            location.ListLocationsResponse = (function() {
                ...
                ListLocationsResponse.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.location.ListLocationsResponse();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                ListLocationsResponse.verify = function verify(message) {
                    ...
                    if (message.locations != null && message.hasOwnProperty("locations")) {
                        ...
                        for (let i = 0; i < message.locations.length; ++i) {
                            let error = $root.google.cloud.location.Location.verify(message.locations[i]);
                            if (error)
                ...
                ListLocationsResponse.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.cloud.location.ListLocationsResponse)
                        return object;
                    let message = new $root.google.cloud.location.ListLocationsResponse();
                    if (object.locations) {
                 ...
                 * @returns {string} The default type url
                 */
                ListLocationsResponse.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/google.cloud.location.ListLocationsResponse";
                };
            ...
            location.GetLocationRequest = (function() {
                ...
                GetLocationRequest.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.location.GetLocationRequest();
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                GetLocationRequest.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.cloud.location.GetLocationRequest)
                        return object;
                    let message = new $root.google.cloud.location.GetLocationRequest();
                    if (object.name != null)
                        message.name = String(object.name);
                    return message;
                };
                ...
                /**
                 * Gets the default type url for GetLocationRequest
                 * @function getTypeUrl
                 * @memberof google.cloud.location.GetLocationRequest
                 * @static
                 * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
                 * @returns {string} The default type url
                 */
                GetLocationRequest.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    if (typeUrlPrefix === undefined) {
                        typeUrlPrefix = "type.googleapis.com";
                    }
                    return typeUrlPrefix + "/google.cloud.location.GetLocationRequest";
                };
            ...
            location.Location = (function() {
                ...
                Location.decode = function decode(reader, length) {
                    if (!(reader instanceof $Reader))
                        reader = $Reader.create(reader);
                    let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.cloud.location.Location(), key, value;
                    while (reader.pos < end) {
                        let tag = reader.uint32();
                        switch (tag >>> 3) {
                        case 1: {
                ...
                Location.fromObject = function fromObject(object) {
                    if (object instanceof $root.google.cloud.location.Location)
                        return object;
                    let message = new $root.google.cloud.location.Location();
                    if (object.name != null)
                        message.name = String(object.name);
                ...
                Location.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                    ...
                    return typeUrlPrefix + "/google.cloud.location.Location";
                };
    ...
    google.api = (function() {
        ...
        api.GoSettings = (function() {
            ...
            GoSettings.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                let end = length === undefined ? reader.len : reader.pos + length, message = new $root.google.api.GoSettings();
                while (reader.pos < end) {
                    let tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1: {
