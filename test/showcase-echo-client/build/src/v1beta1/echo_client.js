...
class EchoClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            blueprintPathTemplate: new this._gaxModule.PathTemplate('sessions/{session}/tests/{test}/blueprints/{blueprint}'),
            roomPathTemplate: new this._gaxModule.PathTemplate('rooms/{room_id}'),
            roomIdBlurbIdPathTemplate: new this._gaxModule.PathTemplate('rooms/{room_id}/blurbs/{blurb_id}'),
            roomIdBlurbsLegacyRoomIdBlurbIdPathTemplate: new this._gaxModule.PathTemplate('rooms/{room_id}/blurbs/legacy/{legacy_room_id}.{blurb_id}'),
            sessionPathTemplate: new this._gaxModule.PathTemplate('sessions/{session}'),
            testPathTemplate: new this._gaxModule.PathTemplate('sessions/{session}/tests/{test}'),
            userPathTemplate: new this._gaxModule.PathTemplate('users/{user_id}'),
            userIdProfileBlurbIdPathTemplate: new this._gaxModule.PathTemplate('user/{user_id}/profile/blurbs/{blurb_id}'),
            userIdProfileBlurbsLegacyUserIdBlurbIdPathTemplate: new this._gaxModule.PathTemplate('user/{user_id}/profile/blurbs/legacy/{legacy_user_id}~{blurb_id}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            pagedExpand: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'responses'),
        };
        ...
        const waitResponse = protoFilesRoot.lookup('.google.showcase.v1beta1.WaitResponse');
        const waitMetadata = protoFilesRoot.lookup('.google.showcase.v1beta1.WaitMetadata');
        this.descriptors.longrunning = {
            wait: new this._gaxModule.LongrunningDescriptor(this.operationsClient, waitResponse.decode.bind(waitResponse), waitMetadata.decode.bind(waitMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.showcase.v1beta1.Echo', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.echoStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.showcase.v1beta1.Echo')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.showcase.v1beta1.Echo, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of echoStubMethods) {
            const callPromise = this.echoStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    echo(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
    ...
    block(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    collect(optionsOrCallback, callback) {
    ...
    pagedExpand(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    pagedExpandStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.pagedExpand.createStream(this.innerApiCalls.pagedExpand, request, callSettings);
    }
    /**
    ...
    pagedExpandAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.pagedExpand.asyncIterate(this.innerApiCalls['pagedExpand'], request, callSettings);
    }
    /**
     ...
     */
    blueprintPath(session, test, blueprint) {
     ...
     */
    matchSessionFromBlueprintName(blueprintName) {
     ...
     */
    matchTestFromBlueprintName(blueprintName) {
     ...
     */
    matchRoomIdFromRoomName(roomName) {
     ...
     * @returns {string} Resource name string.
     */
    roomIdBlurbIdPath(roomId, blurbId) {
     ...
     * @returns {string} A string representing the room_id.
     */
    matchRoomIdFromRoomIdBlurbIdName(roomIdBlurbIdName) {
     ...
     */
    matchBlurbIdFromRoomIdBlurbIdName(roomIdBlurbIdName) {
        return this.pathTemplates.roomIdBlurbIdPathTemplate.match(roomIdBlurbIdName)
            .blurb_id;
    }
    /**
     ...
     * @returns {string} Resource name string.
     */
    roomIdBlurbsLegacyRoomIdBlurbIdPath(roomId, legacyRoomId, blurbId) {
     ...
     * @returns {string} A string representing the room_id.
     */
    matchRoomIdFromRoomIdBlurbsLegacyRoomIdBlurbIdName(roomIdBlurbsLegacyRoomIdBlurbIdName) {
     ...
     */
    matchLegacyRoomIdFromRoomIdBlurbsLegacyRoomIdBlurbIdName(roomIdBlurbsLegacyRoomIdBlurbIdName) {
     ...
     * @returns {string} A string representing the blurb_id.
     */
    matchBlurbIdFromRoomIdBlurbsLegacyRoomIdBlurbIdName(roomIdBlurbsLegacyRoomIdBlurbIdName) {
     ...
     * @returns {string} A string representing the session.
     */
    matchSessionFromTestName(testName) {
     ...
     * @returns {string} A string representing the test.
     */
    matchTestFromTestName(testName) {
     ...
     */
    matchUserIdFromUserName(userName) {
     ...
     * @returns {string} Resource name string.
     */
    userIdProfileBlurbIdPath(userId, blurbId) {
     ...
     * @returns {string} A string representing the user_id.
     */
    matchUserIdFromUserIdProfileBlurbIdName(userIdProfileBlurbIdName) {
     ...
     * @returns {string} A string representing the blurb_id.
     */
    matchBlurbIdFromUserIdProfileBlurbIdName(userIdProfileBlurbIdName) {
     ...
     * @returns {string} Resource name string.
     */
    userIdProfileBlurbsLegacyUserIdBlurbIdPath(userId, legacyUserId, blurbId) {
     ...
     * @returns {string} A string representing the user_id.
     */
    matchUserIdFromUserIdProfileBlurbsLegacyUserIdBlurbIdName(userIdProfileBlurbsLegacyUserIdBlurbIdName) {
     ...
     */
    matchLegacyUserIdFromUserIdProfileBlurbsLegacyUserIdBlurbIdName(userIdProfileBlurbsLegacyUserIdBlurbIdName) {
     ...
     * @returns {string} A string representing the blurb_id.
     */
    matchBlurbIdFromUserIdProfileBlurbsLegacyUserIdBlurbIdName(userIdProfileBlurbsLegacyUserIdBlurbIdName) {
...
//# sourceMappingURL=echo_client.js.map